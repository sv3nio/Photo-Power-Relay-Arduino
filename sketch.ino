/*
LIGHT RELAY (by Sven Thomas)
====================================================================================
A simple photosensitive power relay for controlling lights with BLE for wireless
command and control. Presently, the relay supports the following:
...
- An automatic power-off timer during the night using a sensible default. This value
  is customizable in volitile memory and resets on power cycle.
...
2022.09.21 - v1.0 BETA
 ...
 - Code refactoring for performance and stability
